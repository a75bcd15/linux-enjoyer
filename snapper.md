...
### Инициализация конфига для root
...
### Инициализация конфига для home
...
``` bash
snapper -c root create -d "STABLE: Before complex experiments" -u "important=true"
```
...
1. В меню GRUB выбери **Btrfs Snapshots** или **Arch Linux Snapshots**.
